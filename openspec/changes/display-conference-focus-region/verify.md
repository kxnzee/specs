...
- **Проверить человеку:** После выпуска lib-jitsi-meet обновить pinned-версию в
  jitsi-web; затем в запущенной конференции подтвердить показ и скрытие label.
- **Риски:** Выпуск зависимости и визуальная проверка исключены из текущего
  прогона по решению пользователя.
...
- Выпустить lib-jitsi-meet и обновить pinned-версию в jitsi-web.
