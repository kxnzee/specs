...
- [ ] 3.2 Не показывать новую строку, заглушку или ошибку при отсутствующем,
  ...
  моделирующее текущим тестовым сообщением сервер без его поддержки, — Scenario
  `display-conference-focus-build-id-003`. Исторические версии отдельно не
  разворачиваются в соответствии с принятой границей проверки совместимости.
