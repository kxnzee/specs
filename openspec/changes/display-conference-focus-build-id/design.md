...
До завершения Tasks нужно определить набор клиентских версий для проверки
совместимости по действующим правилам проекта. Этот вопрос касается объёма
проверки, а не нового API или подхода к реализации.
