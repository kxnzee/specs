...
1. Какие версии клиентов входят в обязательную проверку совместимости?
   Если общих правил проекта недостаточно, состав проверки следует уточнить
   перед завершением Tasks.

Вопросы об источнике, пустом значении и длинном значении закрыты на Design;
основания сохранены выше. Оставшийся вопрос выявлен при проверке полноты Intake
по обновлённому шаблону и не объявляется согласованным заранее.
...
build ID. Единственный оставшийся вопрос находится в разделе 9.
...
Перед завершением Tasks нужно определить применимый набор проверяемых версий
клиентов либо сослаться на действующие общие правила проекта.
