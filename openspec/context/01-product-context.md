...
- Центральный Store координирует четыре Code Repository: `jitsi-web`,
  `lib-jitsi-meet`, `jitsi-control` и `jitsi-videobridge`. Их общие ответственности
  описаны в `system-map.yaml`.
